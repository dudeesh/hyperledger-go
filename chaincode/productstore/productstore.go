...
// ProductStore example simple Chaincode implementation
type ProductStore struct {
}

func main() {
	err := shim.Start(new(ProductStore))
	if err != nil {
...
func (t *ProductStore) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *ProductStore) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *ProductStore) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *ProductStore) write(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ProductStore) read(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *ProductStore) addProduct(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
